...
hexo.extend.helper.register('export_config', function () {
  ...
  return `<script id="hexo-configurations">
    let MATERY = window.MATERY || {};
    MATERY.hexo_config = ${JSON.stringify(hexo_config)};
    MATERY.theme_config = ${JSON.stringify(theme_config)};
    MATERY.language_ago = ${JSON.stringify(languageContent['ago'])};
  </script>`;
});
